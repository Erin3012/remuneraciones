...
final class PayrollCalculator {
    ...
    public function calculate(array $e, array $v, array $p): array {
        ...
        return compact('days','sb','lic','ot50','ot100','bonus','comm','grat','taxable','afpCap','scCap','afpBase','scBase','afp','health','additional','scWorker','iusc','meal','transport','family','nonTax','haberes','discounts','sis','mutual','scEmployer','sanna','reformAfp','reformSsp') + ['net'=>max(0,$haberes-$discounts),'employer_total'=>$sis+$mutual+$scEmployer+$sanna+$reformAfp+$reformSsp,'warning'=>$base<self::n($p['minimum_wage'])?'Bajo ingreso mínimo':''];
    }
